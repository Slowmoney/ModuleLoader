...
namespace core {
	...
	using alt::MValue;
	using alt::MValue;
	using alt::MValueConst;
	using alt::MValueNone;
	using alt::MValueNil;
	using alt::MValueBool;
	using alt::MValueInt;
	using alt::MValueUInt;
	using alt::MValueDouble;
	using alt::MValueString;
	using alt::MValueList;
	using alt::MValueDict;
	using alt::MValueBaseObject;
	using alt::MValueFunction;
	using alt::MValueVector2;
	using alt::MValueVector3;
	using alt::MValueRGBA;
	using alt::MValueByteArray;
