...
namespace core {
    ...
    using alt::IBaseObject;
    using alt::IMValueFunction;
    using alt::Vector2f;
    using alt::Vector3f;
    using alt::RGBA;
    using alt::Size;
    ...
    using alt::IVehicle;
    using alt::IBlip;
    using alt::ICheckpoint;
    using alt::IPed;
    using alt::IVirtualEntity;
    using alt::IVirtualEntityGroup;
    using alt::INetworkObject;
    using alt::MValueArgs;
    using alt::Array;
    using alt::Permission;
	using alt::Position;
	using alt::Rotation;
	using alt::VehicleModelInfo;
	using alt::PedModelInfo;
	using alt::IVoiceChannel;
	using alt::IColShape;
    ...
    public:
        ...
        virtual MValueList CreateMValueList(alt::Size size = 0) = 0;
